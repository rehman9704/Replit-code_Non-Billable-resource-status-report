...
// Test client access for each user
async function testClientAccess() {
  ...
  console.log('Testing client-based access for users:');
  console.log('==========================================');

  for (const userEmail of users) {
    const allowedClients = clientMappings[userEmail] || [];
    ...
    try {
      ...
      console.log(`${userEmail}: ${result.total} employees (${allowedClients.length} clients assigned)`);
